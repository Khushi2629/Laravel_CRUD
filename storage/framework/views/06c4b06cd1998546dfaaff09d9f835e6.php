...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form action="<?php echo e(url('student/' .$students->id)); ?>" method="post">
        ...
        <input type="text" name="enrollment" id="enrollment" value="<?php echo e($students->enrollment); ?>" class="form-control"></br>
        <label>Dance</label></br>
        <input type="text" name="dance" id="dance" value="<?php echo e($students->dance); ?>" class="form-control"></br>
...
<?php echo $__env->make('students.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/shubhampal/Desktop/laravelproject/studentcrud-app/resources/views/students/edit.blade.php ENDPATH**/ ?>
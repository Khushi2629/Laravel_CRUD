                            ...
                            <table class="table">
                                ...
                                <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($item->enrollment); ?></td>
                                        <td><?php echo e($item->dance); ?></td>
...
<?php echo $__env->make('students.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/shubhampal/Desktop/laravelproject/studentcrud-app/resources/views/students/index.blade.php ENDPATH**/ ?>